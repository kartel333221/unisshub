-- UnissHub: Fixed Labels + Bigger TP Fonts
...
sg.Name = "UnissHub_Corrected"; sg.ResetOnSpawn = false
...
local pageTp = Instance.new("ScrollingFrame", container); pageTp.Size = UDim2.new(1, 0, 0.8, 0); pageTp.Position = UDim2.new(0,0,0.1,0); pageTp.BackgroundTransparency = 1; pageTp.Visible = false; pageTp.ScrollBarThickness = 3; pageTp.CanvasSize = UDim2.new(0,0,2,0)
...
for _, data in pairs(islands) do
    ...
    b.Size = UDim2.new(0.9, 0, 0, 40) -- Чуть выше кнопки
    b.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
    b.Text = data[1]
    b.TextColor3 = Color3.new(1,1,1)
    b.Font = Enum.Font.GothamBold -- Жирный
    b.TextSize = 18 -- Больше шрифт
...
toggleAC.TextColor3 = Color3.new(1,1,1); toggleAC.Font = Enum.Font.GothamBold; toggleAC.TextSize = 19
Instance.new("UICorner", toggleAC); applyClickEffect(toggleAC)
...
local speedLabel = Instance.new("TextLabel", speedFrame) -- Надпись вернулась
speedLabel.Size = UDim2.new(1, 0, 0, 25); speedLabel.Position = UDim2.new(0, 0, 0, 5)
speedLabel.BackgroundTransparency = 1; speedLabel.Text = "Click Delay (seconds)"
speedLabel.TextColor3 = Color3.fromRGB(200, 200, 200); speedLabel.Font = Enum.Font.GothamBold; speedLabel.TextSize = 14

local speedInput = Instance.new("TextBox", speedFrame)
speedInput.Size = UDim2.new(0.9, 0, 0, 30); speedInput.Position = UDim2.new(0.05, 0, 0.45, 0)
